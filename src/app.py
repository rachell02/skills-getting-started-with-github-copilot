...
activities = {
    ...
    "Basketball Training": {
        "description": "Skills development and drills for basketball players",
    ...
    "Drama Society": {
        "description": "Acting, stagecraft, and theater production workshops",
    ...
    "Science Olympiad": {
        "description": "Study science challenges and compete in academic events",
